                ...
                Expanded(
                  child: Container(
                    ...
                    child: TextFormField(
                        ...
                        controller: selectedNeighborhoodUI,
                        validator: (value) {
                          if (value == '') {
            ...
            Row(
              children: <Widget>[
                Expanded(
                  ...
                  child: TextFormField(
                    autovalidateMode: AutovalidateMode.onUserInteraction,
                    controller: textCtrlPlatePart1UI,
                    ...
                    onSaved: (val) => ontextCtrlPlatePart1,
                  ),
                ),
                Expanded(
                  flex: 1,
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    autovalidateMode: AutovalidateMode.onUserInteraction,
                    controller: textCtrlPlatePart2UI,
                    textAlign: TextAlign.center,
                    decoration: new InputDecoration(
                      hintText: '34',
                      hintStyle: TextStyle(color: kCustomHintColor),
                    ...
                    onSaved: (val) => ontextCtrlPlatePart2,
                  ),
                ),
                Expanded(
                  flex: 1,
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    autovalidateMode: AutovalidateMode.onUserInteraction,
                    controller: textCtrlPlatePart3UI,
                    textAlign: TextAlign.center,
                    decoration: new InputDecoration(
                      hintText: '26',
                      hintStyle: TextStyle(color: kCustomHintColor),
                    ...
                    onSaved: (val) => ontextCtrlPlatePart3,
                  ),
                ),
              ],
            ),
              ...
              children: <Widget>[
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    onSaved: (val) => onTextCtrlAdditionalInfo,
                  ),
                ),
              ],
            ),
