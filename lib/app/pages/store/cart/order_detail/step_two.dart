...
class _StepTwoState extends State<StepTwo> {
  ...
  late List deliveryDays;
  late List deliveryHoursDaySelected;

  late String dayIdSelected;
  late String? hourIdSelected;
  ...
  Widget _getSliderDaysWidget({required BuildContext context}) {
    return Container(
      height: 120.0,
  ...
  Widget _getDeliveryHoursWidget({required BuildContext context}) {
  ...
  Widget _getErrorMessage({required BuildContext context}) {
    return Visibility(
