...
class _StepFourState extends State<StepFour> {
  late int customerTypeValue;

  late String typeIdSelected;
  ...
  Widget _getCustomerTypeWidget({required BuildContext context}) {
    return Column(
              ...
              Expanded(
                child: Container(
                  child: RadioListTile(
                    ...
                    onChanged: (value) => radioButtonChecked,
                    title: Text('Persona'),
  ...
  Widget _getBillFormWidget({required BuildContext context}) {
    return Expanded(
      child: Visibility(
  ...
  Widget _getFullNameField({required BuildContext context}) {
    return Padding(
      ...
      child: TextFormField(
        ...
        onSaved: (String? value) {
          setState(() {
            userBilledData['full_name'] = value;
  ...
  Widget _getDocumentTypeField({required BuildContext context}) {
        ...
        child: DropdownButtonFormField(
          ...
          onChanged: (value) {
            setState(() {
              ...
              userBilledData['identification_type'] = value;
            });
          },
          decoration: InputDecoration(
            isDense: inputIsDense,
          ...
          onSaved: (String? value) {
            setState(() {
              userBilledData['identification_type'] = typeIdSelected;
              widget.saveData(userBilledData);
            });
          },
        ),
  ...
  Widget _getDocumentNumberField({required BuildContext context}) {
    return Padding(
      padding: EdgeInsets.only(top: paddingBillFormWidgetField),
      child: TextFormField(
        autovalidateMode: AutovalidateMode.onUserInteraction,
        ...
        onSaved: (String? value) {
          setState(() {
            userBilledData['identification_number'] = value;
            widget.saveData(userBilledData);
          });
        },
      ),
