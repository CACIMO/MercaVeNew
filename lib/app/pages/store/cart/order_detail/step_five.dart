...
class _StepFiveState extends State<StepFive> {
  ...
  late String address;
  late String shippingDay;
  late String paymentMethodText;
  late String paymentMethodSubtitle;
  ...
  Widget _getOrderNotesField({required BuildContext context}) {
    return Padding(
  ...
  /// ======================================================================
  Widget _getCartResumeWidget({required BuildContext context}) {
