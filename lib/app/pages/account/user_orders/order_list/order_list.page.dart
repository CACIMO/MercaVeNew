...
class _OrderListPageState extends State<OrderListPage> {
  ...
  Widget _orderListWidget({required BuildContext context}) {
    if (orders.length > 0) {
  ...
  Widget _getOrderListItem({required BuildContext context, dynamic order}) {
  ...
  Widget _getEmptyCartWidget({required BuildContext context}) {
