...
class _UserFormPageState extends State<UserFormPage> {
  ...
  Widget _getHeaderBackground({required BuildContext context}) {
  ...
  Widget _getUserHeaderInfoWidget({required BuildContext context}) {
    return Container(
      height: 180.0,
      width: MediaQuery.of(context).size.width,
      child: Column(
        children: <Widget>[
          CircleAvatar(
            ...
            backgroundImage: returnImgBk(this.userData['avatar']),
          ),
  ...
  Widget _getUserForm({required BuildContext context}) {
    return Container(
      decoration: BoxDecoration(
        border: Border(
          top: BorderSide(
  ...
  Widget _getFirstNameField({required BuildContext context}) {
    return Padding(
  ...
  Widget _getLastNameField({required BuildContext context}) {
    return Padding(
  ...
  Widget _getPhoneField({required BuildContext context}) {
    return Padding(
      padding: const EdgeInsets.only(top: 12.0),
      child: TextFormField(
  ...
  Widget _getEmailField({required BuildContext context}) {
    return Padding(
      padding: const EdgeInsets.only(top: 12.0),
      child: TextFormField(
  ...
  Widget _getPasswordField({required BuildContext context}) {
    return Padding(
      padding: const EdgeInsets.only(top: 12.0),
      child: TextFormField(
  ...
  Widget _getPasswordConfirmationField({required BuildContext context}) {
    return Padding(
      padding: const EdgeInsets.only(top: 12.0),
      child: TextFormField(
  ...
  Widget _getSaveButton({required BuildContext context}) {
    return Padding(
