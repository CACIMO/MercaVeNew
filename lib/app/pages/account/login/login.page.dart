...
class _LoginPageState extends State<LoginPage> {
  ...
  AppBar _getAppBarWidget({required BuildContext context}) {
    return AppBar(
      title: Text(''),
  ...
  Widget _getHeaderLogo({required BuildContext context}) {
    return Column(
      children: <Widget>[
        Padding(
  ...
  Widget _getLoginButton({required BuildContext context}) {
    return Container(
  ...
  Widget _getRegisterButton({required BuildContext context}) {
    return Container(
