...
class LocalStorageDBService {
  ...
  static Future setItem({required String key, String? value}) async {
    String query;
    ...
    try {
      ...
      (e);
      return Future.error(
          ExceptionService.databaseException(message: e.toString()));
    }
  ...
  static Future removeItem({required String key}) async {
    try {
      final db = await SQLiteService.db.database;
  ...
  static Future itemExist({required String key}) async {
