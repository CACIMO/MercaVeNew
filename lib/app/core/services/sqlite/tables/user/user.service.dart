...
class UserDBService {
  ...
  static Future createUpdateUser({required Map userData}) async {
    try {
  ...
  static Future getUserById({required int id}) async {
    Map? user;
  ...
  static Future createUser({required Map userData}) async {
    try {
      final db = await SQLiteService.db.database;
      List fields = [];
      List values = [];
  ...
  static Future updateUser({required int id, required Map userData}) async {
    userData.remove('id');
